...
namespace TasksFrontEnd.HttpRepository
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<RegistrationResponseDto> RegisterUser(UserForRegistrationDto userForRegistration)
        {
            ...
            var registrationResult = await _client.PostAsync("User/register", bodyContent);
        ...
        public async Task<AuthResponseDto> Login(UserForAuthenticationDto userForAuthentication)
        {
            ...
            ((AuthStateProvider)_authStateProvider).NotifyUserAuthentication(userForAuthentication.username , result.RoLe);
